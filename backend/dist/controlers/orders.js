...
exports.getOrder = exports.addProduct = exports.create = exports.index = exports.show = void 0;
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersStore.show(parseInt(req.params.id))];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var addProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products_id, quantity, orders_id, addedProduct, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                products_id = _req.body.products_id;
                quantity = _req.body.quantity;
                orders_id = parseInt(_req.params.id);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ordersStore.addProduct(products_id, quantity, orders_id)];
            case 2:
...
var getOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users_id, theorder, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                users_id = parseInt(req.params.id);
                return [4 /*yield*/, ordersStore.getOrder(users_id)];
            case 1:
                theorder = _a.sent();
                res.json(theorder);
                return [3 /*break*/, 3];
